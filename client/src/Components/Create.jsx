    ...
    try {
      ...
      if (response.ok) {
        ...
        if (data.token && data.user && data.user.id) {
          // If a token and user ID are received, the account creation was successful
        ...
        <ul className="list-none">
          ...
          <form>
            ...
            <form style={buttonContainerStyle}>
              <li>
                <Link to="/">
                  <button className="bg-gray-700 hover:bg-blue-100 text-blue-400 py-2 px-4 rounded-full">
                    <h1>Back</h1>
                  </button>
                </Link>
              </li>
